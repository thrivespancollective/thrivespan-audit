...
const SPRINT_PS = {
  ...
  // NO DATES. The Sprint runs the first full week of every month — that
  // sentence is always true. A specific date in a rolling nurture goes stale
  // within two weeks and nobody notices. The date lives on the Circle
  // checkout page, in one place.
  body:
    "You've never doubted you could do it once. The Sprint is five days in a row \u2014 Monday to Friday, 45 minutes \u2014 because five is where \u201cI did it\u201d turns into \u201cthis is who I am.\u201d It runs the first full week of every month, and your 30 days on TeamQueen start the day you join.",
  cta: "Take the Sprint",
};
