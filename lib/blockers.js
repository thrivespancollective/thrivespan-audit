...
export const BLOCKER_COPY = {
  unguarded: {
    ...
    // ⚠️ Fixed 2026-08-05 — this read "same time every week," which describes
    // TeamQueen, not Your First Win. The room is ONE session. Keep every
    // promise in this file true of a single hour.
    promise:
      "One hour. You'll claim it, put your name on it, and build the version that survives a bad Tuesday.",
  },
...
export const RESULT_CTA = {
  ...
  // ONE room, ONE time — panel 2026-08-05. Melissa's catch: the page that
  // diagnoses "Too Many Tabs Open" (women who freeze on options) was handing
  // her three times to choose between. Show one. Note this stays evergreen —
  // it's the recurring slot, not a date, so there's nothing to update weekly.
  times: "Next room: Monday, 10:30am CT",
  ...
  cta: "I'm In",
  // Locked 2026-08-06 — one sign-off everywhere: assessment, results email,
  // Circle confirmations, nurture. Comma, and keep the "your."
