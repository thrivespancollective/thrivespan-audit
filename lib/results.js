...
// LEVER — Block B — names where the leverage is (per Fix B, 2026-06-05)
// The lever is NOT framed as cascade trigger — that's a separate concept revealed
// in the cascade-trigger callout (uses Meta Q2 subjective answer).
// The lever IS framed as: where you have the most room — biggest growth payoff.
export const EDGE_COPY = {
  move: {
    headline: "Your lever is Move.",
    body: "This is where your biggest room is — and where focused work compounds fastest. Most likely, what's showing up in your life right now: your workouts feel like work without payoff. You're putting in the cardio your Garmin tells you to and the scale doesn't move. You're not sure if you're lifting heavy enough to build — and somewhere underneath, you know the body that built you at 35 isn't responding to the same playbook now.",
  ...
  nourish: {
    ...
    body: "This is where your biggest room is — the pillar where focused work pays back across all the others. Most likely, what's showing up in your life right now: your bloodwork comes back \"normal\" and you feel anything but. You eat protein now and the scale doesn't move. You may be considering — or already using — HRT, peptides, or a GLP, and somewhere underneath you know the habits aren't matching the tools.",
  ...
  restore: {
    ...
    body: "This is where your biggest room is — the platform every other pillar can build on once it's running. Most likely, what's showing up in your life right now: you're not sleeping but you keep pushing. You lost a word mid-sentence in a meeting last week and felt the small chill. The brain fog you didn't have at 35 is the one you're trying not to name. And if Alzheimer's or dementia runs in your family, there's a quiet hum underneath: \"is this just how it is now?\"",
  ...
  connect: {
    ...
    body: "This is where your biggest room is. The leverage isn't more effort in Move or Nourish — it's adding Connect to the system that's already working. Most likely, what's showing up in your life right now: you're navigating peri/menopause without women in your same season. You're doing this alone with Google and contradicting podcasts. Your closest people don't know what's happening in your body — and the work you're doing in the other pillars compounds slower because no one's witnessing it.",
...
// CTAs — Block F — Personalized primary per audit signal (v10.4, Approach C).
// The Realm Lab is the substantive default for foundation-strong + heavy-lift routes
// (Code → Realm IS the locked ascension path). Masterclass stays primary only for
// entry-door buyers (Wake-Up / high composite). Move Accelerator primary for Move-lever.
export const CTA_COPY = {
  masterclass: {
    headline: "Your next step: The Masterclass.",
    body: "You're at the front door — either running a tight system already, or at the Wake-Up ready to name what's shifting. Either way, the Masterclass — Less Knowing. More Doing. — is where the four-pillar lens, the structure that holds the doing, and your first habit get installed. Weekly Friday live.",
    details: "Friday weekly · live · $39 · recording sent.",
  ...
  sus_lab: {
    ...
    body: "Your foundation is strong, and you have ONE clear lever. Create Your Realm is the 3-night live lab where you design the conditions — calendar, identity, the Court, easy buttons — that make your lever habit hold. Not willpower. The realm where your Queen Playbook can run.",
    details: "3 nights · live · $147 · $147 credit toward Move or Build (apply within 14 days).",
  ...
  the_build: {
    headline: "Your next step: Create Your Realm.",
    body: "Your Code revealed the pattern — and you're ready for the system that holds the doing. Create Your Realm is the 3-night live lab where you design your environment first — the identity, the Court, the schedule, the easy buttons. It's literally Weeks 1-2 of The Build, run standalone. The natural on-ramp.",
    details: "3 nights · live · $147 · $147 credit toward The Build (apply within 14 days).",
    button: "Save my seat — Create Your Realm",
    href: "https://thrivespancollective.circle.so",
