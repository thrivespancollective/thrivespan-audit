...
export const LEVERAGE_PLAYS = {
  ...
  default: (anchor, edge) => ({
    ...
    closer: "This is how the system stays integrated — one anchor, one lever, one wedge.",
  }),
};
...
export const CTA_COPY = {
  ...
  the_build: {
    ...
    body: "Your lever isn't a single pillar — the integrated 4-pillar system is what compounds for you. The Build delivers it.",
