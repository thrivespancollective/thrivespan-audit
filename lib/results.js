...
// CTAs — Block F — Masterclass is the universal primary next step per locked offer flow.
// The route from scoring controls which SECONDARY offer surfaces alongside it.
export const CTA_COPY = {
  masterclass: {
    headline: "Your next step: The Masterclass.",
    body: "You're running a tight system. The Masterclass — Less Knowing. More Doing. — is where the four-pillar lens, the structure that holds the doing, and your first habit get installed. Weekly Friday live.",
  ...
  sus_lab: {
    headline: "Your next step: The Masterclass.",
    body: "Your foundation is strong, and you have ONE clear lever. The Masterclass — Less Knowing. More Doing. — is where structure, accountability, and community get installed. From there, Create Your Realm is the 3-night live lab where you architect the conditions that make your lever habit hold.",
    details: "Friday weekly. Live. $39. Recording sent.",
    button: "Save my seat — The Masterclass",
    href: "https://thrivespanmasterclass.carrd.co",
    secondaryButton: "Or: tell me about Create Your Realm",
  ...
  move_accelerator: {
    headline: "Your next step: The Masterclass.",
    body: "Move is where the work is. Before you commit to a 12-week single-pillar program, the Masterclass — Less Knowing. More Doing. — is where you see how the system holds and what your first habit looks like. The Move Accelerator is the natural next step for Move-lever Queenagers.",
    details: "Friday weekly. Live. $39. Recording sent.",
    button: "Save my seat — The Masterclass",
    href: "https://thrivespanmasterclass.carrd.co",
    secondaryButton: "Or: tell me about The Move Accelerator",
    secondaryHref: "https://thrivespanmove.carrd.co",
  },
  the_build: {
    headline: "Your next step: The Masterclass.",
    body: "Your Code revealed the pattern — and you're ready for the system that holds the doing. The Masterclass — Less Knowing. More Doing. — is the front door. The Build is the 6-month flagship where you author your full Queen Playbook.",
    details: "Friday weekly. Live. $39. Recording sent.",
    button: "Save my seat — The Masterclass",
    href: "https://thrivespanmasterclass.carrd.co",
