...
export const CTA_COPY = {
  masterclass: {
    ...
    secondaryButton: "Tell me about Create Your Realm",
  },
  sus_lab: {
    headline: "Your next step: Create Your Realm.",
    body: "Your foundation is strong. ONE pillar is your lever. Create Your Realm is the 3-night live lab where you set up the structure — calendar, identity, easy buttons — that makes your lever habit stick. Plus a $147 credit toward Move or Build when you go deeper.",
    details: "3 nights. 60 minutes each. $147. $147 credit toward The Move Accelerator OR The Build (apply within 14 days).",
    button: "Save my seat",
