...
export const ANCHOR_COPY = {
  move: {
    ...
    body: "You've built a body that performs. You'll show up to the workout even when the rest of life is fraying. The dopamine, the discipline, the identity — they're locked in. Most Queenagers your age would trade what you've built for almost any other gain. The Move-discipline is YOUR leverage. Hold onto that as we name the edge.",
  },
  nourish: {
...
export const INTEGRATION_COPY = {
  move_restore:
    "Your anchor is Move. Your edge is Restore. This combination is the most common one we see in high-performer Queenagers — and it's also the one where the biggest unlock hides. You've been treating training as the answer to everything. Your nervous system has been quietly paying the bill. When Restore gets a system around it, your training compounds at 2-3× the rate. The work you've been doing in Move isn't wasted — it's about to start landing.",
  move_nourish:
    "Your anchor is Move. Your edge is Nourish. You're loading the body. You're not always fueling it for what you're asking it to do. The result: training that builds slower than it should, body comp that doesn't match the work. The Nourish edge isn't a diet question — it's a system question. When fueling matches load, Move starts paying out in months instead of years.",
  restore_move:
    "Your anchor is Restore. Your edge is Move. You've claimed your nervous system; you sleep; you've built calm. What's missing is load — real load. The body needs HEAVY for the season you're in, and you may have backed off training out of an instinct that's serving you in some ways and limiting you in others. Restore is the platform. Move is the build. Both/AND.",
  connect_move:
    "Your anchor is Connect. Your edge is Move. You have your women, your community, your sisterhood — that's the platform most Queenagers can't even access. What's missing is the body matching the woman you've built. Move is the next chapter. The community holds you while you do it.",
  default: (anchor, edge) =>
    `Your anchor is ${cap(anchor)}. Your edge is ${cap(edge)}. Most Queenagers don't realize how much these two talk to each other. The discipline you've built in ${cap(anchor)} is the leverage point — it's the energy you can borrow to install the work that's been hard in ${cap(edge)}. We don't choose between pillars. We sequence them.`,
};
...
export const LEVERAGE_PLAYS = {
  move_restore: {
    intro: "Your discipline lives in Move — you'll show up to a workout half-dead. The work isn't ADDING more Move. The work is borrowing your Move-discipline and pointing it at Restore.",
    play: "The play: substitute ONE weekly high-arousal session (swim, HIIT, intense cardio) with a low-arousal session (yin yoga, surrender practice, walking nature). Same time slot. Same \"I'm doing this\" energy. Different nervous system signal.",
    closer: "This isn't doing less Move. It's doing Move in service of Restore.",
  },
  move_nourish: {
    intro: "Your discipline lives in Move — you train consistently, you load the body, you show up. The work isn't TRAINING HARDER. The work is matching the fueling to the load.",
    play: "The play: stack ONE fueling habit onto your post-workout window. The 30-60 minutes after you train is the highest-trust moment of your day — the body is asking for input. Use it. Protein hit. Same time. Same place. Same trigger.",
    closer: "This isn't a diet. It's using your Move-anchor as the cue for the Nourish habit you've been not-doing.",
  },
  move_connect: {
    intro: "Your discipline lives in Move — you train, you load, you show up. The work isn't ADDING fitness. The work is using training as the doorway into sisterhood.",
    play: "The play: train with ONE woman, ONCE a week. Doesn't have to be a coach. Doesn't have to be a class. Could be a friend, a sister, a peer. The point — shared sweat is shared identity. Connect happens at the intersection of effort.",
    closer: "Move is your discipline. Sisterhood is your missing health intervention.",
  },
  restore_move: {
    intro: "Your discipline lives in Restore — you sleep, you recover, you've claimed your nervous system. The work isn't MORE rest. The work is using your settled baseline to do hard things.",
    play: "The play: schedule training in your most-rested window (usually AM after a good sleep). You're starting from green; treat training as performance, not pressure. Light load to start. Build progressively. Your nervous system can hold the load — the habit just hasn't been there yet.",
    closer: "This isn't pushing through. It's loading into recovery.",
  },
  connect_move: {
    intro: "Your discipline lives in Connect — you have your women, your community, your sisterhood. The work isn't BUILDING accountability. It's USING the accountability you've already built.",
    play: "The play: name your training intention to ONE woman in your circle. Not to perform for her — to be witnessed by her. Send her a one-line text after each session. Witnessed action compounds 3×.",
    closer: "Connect is your platform. Move is what you build on it.",
  },
  nourish_restore: {
    intro: "Your discipline lives in Nourish — you fuel, you eat for performance, you've built a pattern that holds. The work isn't OPTIMIZING food further. The work is using fueling as the cue for nervous system regulation.",
    ...
    closer: "Your Nourish discipline is the lever. Restore is the next compound.",
  },
  default: (anchor, edge) => ({
    intro: `Your discipline lives in ${cap(anchor)}. The work isn't ADDING more ${cap(anchor)}. The work is borrowing your ${cap(anchor)}-discipline and pointing it at ${cap(edge)}.`,
    play: `The play: identify ONE ${cap(edge)} habit you can stack onto something you ALREADY do in ${cap(anchor)}. The trigger is your existing discipline. The new habit rides on top of it. Same energy. Different signal.`,
    closer: "This is how the system stays integrated — one anchor, one edge, one wedge.",
  }),
};
...
export const REANCHOR_ROUTINES = {
  move_restore: {
    ...
    closer: "That's the playbook. Not the willpower-burning version. The version that uses your Move-anchor to do the Restore work.",
  },
  move_nourish: {
  ...
  default: (anchor, edge) => ({
    ...
    closer: "One anchor. One edge. One wedge. That's the whole system.",
  }),
};
...
export const CTA_COPY = {
  workshop: {
    headline: "Your next step: The ThriveSpan Workshop.",
    body: "You're running a tight system. The Workshop is where the nuances and edges get worked. If something quietly bugged you about your score, the workshop is where we go deeper.",
    details: "1-2 hours. Live. $39.",
    button: "Save my seat",
  ...
  sus_lab: {
    ...
    body: "Your foundation is strong. ONE pillar is your edge. The SUS Lab installs the edge habit in 3 nights — using your anchor as the leverage — and gives you a $147 credit toward Move or Build when you're ready.",
  ...
  the_build: {
    ...
    body: "Your edge isn't a single pillar — the integrated 4-pillar system is what compounds for you. The Build delivers it.",
