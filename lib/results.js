...
export const CTA_COPY = {
  masterclass: {
    ...
    body: "You're running a tight system. The Masterclass is where the nuances and edges get worked — the reframe, the 4-pillar lens, your first move. Watch it on your own schedule.",
