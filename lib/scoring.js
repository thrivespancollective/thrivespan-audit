...
export function routeFromScore({ composite, edge, arcStage, trust }) {
  ...
  if (trust && trust <= 3) return "create_your_realm";
  ...
  // Strong foundation, one clear edge: Create Your Realm installs the leverage play.
  if (composite >= 55) return "create_your_realm";
