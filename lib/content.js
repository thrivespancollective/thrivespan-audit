...
export const HERO = {
  ...
  subtitle: "Decode your anchor. Decode your lever. Decode your playbook.",
  body: [
    "You don't have an information problem.",
    "You have a system problem.",
    "",
    "The Queenager Code names the ONE pillar you can rely on no matter what (your anchor) and the ONE pillar that runs off the rails when life gets loud (your lever) — then hands you the play that connects them.",
    "",
    "Numbers AND instinct. The two together name the play.",
    "",
    "About 8 minutes. 4 pillars.",
