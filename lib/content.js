...
export const HERO = {
  ...
  subtitle: "Find your anchor. Find your edge. Find your playbook.",
  body: [
    "You don't have an information problem.",
    "You have a system problem.",
    "",
    "This audit names the ONE pillar you can rely on no matter what (your anchor) and the ONE pillar that runs off the rails when life gets loud (your edge) — then hands you the play that connects them.",
    "",
    "8 minutes. 20 statements. 4 pillars.",
...
export const LANDED_LINE = {
  ...
  hint: "20 of 20. Done with the rating.",
  options: [
...
export const EMAIL_CAPTURE = {
  title: "Where should I send your detailed Audit report?",
  benefits: [
