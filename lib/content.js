...
export const HERO = {
  ...
  subtitle: "Name your anchor. Name your lever.",
  body: [
    "You've got the books. The podcasts. The protocols.",
    "You don't need more information.",
    "You need to see your own pattern.",
    "",
    "The Queenager Code names two things:",
    "",
    "→ Your anchor — the pillar you can rely on, no matter what.",
    "",
    "→ Your lever — the pillar with the most room, where focus has the biggest payoff.",
    "",
    "And the ah-hah that lets you use one to steady the other — before the spiral starts.",
    "",
    "Because you become your own best advocate the moment you see your own pattern.",
    "",
...
export const ARC_STAGE = {
  ...
  options: [
    ...
    },
    {
      id: "assembly",
      label: "The Assembly",
      body: "I have pieces. They haven't come together yet.",
    },
    {
      id: "command",
      label: "The Command",
...
export const EMAIL_CAPTURE = {
  title: "Where can I reach you with your full reading?",
  benefits: [
    "Your full Code Reading — Anchor, Lever, Leverage Play + Re-Anchor Routine — in your inbox",
    "Your personalized next step, matched to your code",
    "ThriveSpan updates when new things drop — no spam, unsubscribe anytime",
  ],
  modernToolsHint:
